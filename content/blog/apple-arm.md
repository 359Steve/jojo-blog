...
cover: '/content/apple-arm/arm.png'
...
> 感谢作者 [CSDN资讯](https://csdnnews.blog.csdn.net/){.text-black .dark:text-white} 允许转载，原文链接：[时隔 15 年，苹果的自研 ARM 芯片为何能取代 Intel 处理器？](https://blog.csdn.net/csdnnews/article/details/106964800){.text-black .dark:text-white}

---

从这个世纪开始，苹果凭借精湛的产品、优秀的软件，以及成熟的生态，俘获了数不胜数的用户和粉丝，成为了智能手机行业利润最高的企业，同时Mac和iPad系列也推出了很多被广泛认可的好产品。

[苹果的灵魂人物乔布斯是工程师出身，而现任CEO库克则是供应链方面的专家。]{.font-[500] .text-black .dark:text-white}
...
[了解了这些背景，就会觉得苹果选择自研电脑芯片是一件十分合乎逻辑的事情。]{.font-[500] .text-black .dark:text-white}

Intel芯片最为消费者所诟病的是在性能上常年“挤牙膏”，至今已经连续6年坚持使用14nm工艺不升级，消费者翘首期盼的7nm工艺仍然遥遥无期，倒逼的一众粉丝都去喊“AMD YES”。

![arm1](/content/apple-arm/arm1.png)
...
[可见，厂商在硬件供应上的话语权和控制力是多么的重要。苹果自研电脑芯片的举措，更是要将这一逻辑贯彻的更深一步。]{.font-[500] .text-black .dark:text-white}
...
![arm3](/content/apple-arm/arm3.png)
...
![arm4](/content/apple-arm/arm4.png)
