...
definePageMeta({
	validate(route) {
		return Boolean(route.params.parentId);
	},
});
	...
	<div class="w-full">
		...
		<div class="w-full py-4 sm:py-8">
			...
			<AnimationRevealOnScroll animation-class="animate__fadeInDown" base-class="text-center text-gray-400">
				...
				handle pressure. Can you give me an example of a time you worked under pressure?” The engineer thinks
				for a second and says, “Well… once I deployed to production on a Friday… with no backup… during a team
				meeting… while the CTO was watching… and the internet went down.” The interviewer, wide-eyed, asks,
				“What happened next?” The engineer shrugs, “I updated my LinkedIn.”
			</AnimationRevealOnScroll>
		</div>
