...
<template>
    <div
        class="relative flex justify-center items-center cursor-pointer rounded-base overflow-hidden h-[10rem] sm:h-[12rem] md:h-[14rem] lg:h-[16rem] xl:h-[16rem] 2xl:h-[16rem]">
        <Starport :port="id" class="w-full h-full">
            <RecordDetailImage />
        </Starport>
    </div>
    <div class="w-full py-4 sm:py-8">
        <div class="mb-4 sm:mb-6 text-center font-extrabold text-lg text-gray-500">从Webpack转向Vite，提升开发效率</div>
...
:deep(.el-button) {
    @apply w-24 p-0 text-sm bg-gray-300 text-white dark:text-black border-none
}
