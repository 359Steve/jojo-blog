	...
	<div class="mx-auto w-full sm:w-[75%]">
		...
		<main class="mx-auto w-full">
			<div class="w-full">
				...
				>
					<p class="text-secondary mb-4 ml-0 w-40 text-sm font-normal sm:mb-0 lg:text-base">{{ getItemTime(index) }}</p>
					<div>
						<h5
						...
						<div
							...
							:key="demo.id"
							@click="toDetail(demo)"
							class="group my-2 flex cursor-pointer items-start space-x-1"
						>
							<svg
