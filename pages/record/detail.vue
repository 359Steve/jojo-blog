...
<template>
	<div class="w-full">
		...
		<AnimationRevealOnScroll
			...
			base-class="relative flex justify-center items-center cursor-pointer rounded-base overflow-hidden h-[10rem] sm:h-[12rem] md:h-[14rem] lg:h-[16rem] xl:h-[16rem] 2xl:h-[16rem]"
		>
			<RecordDetailImage />
		</AnimationRevealOnScroll>
		<div class="w-full py-4 sm:py-8">
			...
			<AnimationRevealOnScroll animation-class="animate__fadeInDown" base-class="text-center text-gray-400">
				A software engineer walks into a job interview. The interviewer says, “We’re looking for someone who can handle
				pressure. Can you give me an example of a time you worked under pressure?” The engineer thinks for a second and
				says, “Well… once I deployed to production on a Friday… with no backup… during a team meeting… while the CTO was
				watching… and the internet went down.” The interviewer, wide-eyed, asks, “What happened next?” The engineer
		...
		<div class="mt-4 w-full py-8">
			...
			>
				<div
					...
					:key="item"
					:class="[
						'flex-shrink-0 overflow-hidden sm:row-span-1 sm:w-full',
